      ...
      <div className="navbar-contenedor">
        ...
        <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
          <div className="navbar-logo">
            ...
            <img 
              src="/Exclusive_Logo.png" 
              alt="Exclusive Detail" 
              className="navbar-logo-img"              
              />
            {/* <span className="navbar-marca-texto"></span> */}
          </div>
        </Link>
        ...
        <ul className="navbar-links">
          <li>
             <Link
              to="/"
              onClick={() => localStorage.setItem("scrollto", "paquetes")}
              className="nav-link"
            >
              Paquetes
            </Link>
          ...
          <li>
            ...
            <Link
              to="/"
              onClick={() => localStorage.setItem("scrollto", "servicios")}
              className="nav-link"
            >
              Servicios
            </Link>
          ...
          <li>
            <Link
              to="/"
              onClick={() => localStorage.setItem("scrollto", "premium")}
              className="nav-link"
            >
              Preventa Premium
            </Link>
          ...
          <li>
            <Link
              to="/"
              onClick={() => localStorage.setItem("scrollto", "galeria")}
              className="nav-link"
            >
              Galeria
            </Link>
        ...
        <ul className="mobile-links">
          <li>
           <Link 
              to="/" 
              onClick={() => {
                localStorage.setItem("scrollto", "paquetes");
                cerrarMenu();
              }}
            >
              Paquetes
          ...
          <li>
            ...
            <Link 
              to="/" 
              onClick={() => {
                localStorage.setItem("scrollto", "servicios");
                cerrarMenu();
              }}
            >
              Servicios
          ...
          <li>
           <Link 
              to="/" 
              onClick={() => {
                localStorage.setItem("scrollto", "galeria");
                cerrarMenu();
              }}
            >
              {/* Sobre mí */}
